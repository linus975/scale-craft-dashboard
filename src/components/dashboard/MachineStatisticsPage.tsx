...
const MachineStatisticsPage: React.FC<MachineStatisticsPageProps> = ({ 
  machineName = "Bambu Lab X1C", 
  onBack 
}) => {
  return (
    <div className="space-y-6">
      {onBack && (
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Machine Statistics - {machineName}</h2>
            <p className="text-slate-600">Detailed performance metrics and operational data</p>
          </div>
        </div>
      )}
